...
class backward_ADP_solver_Post_Decision_State_Lookup_Table():
...
#            Post_Decision_States=state_space_form_dictionary(PDS_States,0.0)
            ...
            for pds in PostDS:
                ...
                for i in xrange(len(Next_Pre_Dec_States[0])):
                    ...
                    Prob_Val_List[0].append(Next_Pre_Dec_States[1][i])
                    if st in Next_PreDS:
                        if T<Stop_Time:
                            Prob_Val_List[1].append(Next_PreDS[st])
                        else:
                            Prob_Val_List[1].append(0.0)
                    else:    
                        if T<Stop_Time:
                            TempPreDS={}
                            for node in SortedNodeList:
                            ...
                            Prob_Val_List[1].append(MaxVal)
                        else:
                            Prob_Val_List[1].append(0.0)
                        
                S=sum(Prob_Val_List[0])
                Val=0.0
                for i in xrange(len(Prob_Val_List[0])):
                    Val+=float(Prob_Val_List[0][i]*Prob_Val_List[1][i])/S
                PostDS[pds]=Val
            ...
            print 'Number of post decision states: ', str(len(PostDS))
